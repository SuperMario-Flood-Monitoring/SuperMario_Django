...
현재 구현 상태:
- React editor JSON -> SWMM INP 변환은 `swmm_engine.converter` 내부 구현을 감싼다.
- PySWMM 실행/세션 제어는 `swmm_engine.engine` 내부 구현을 감싼다.
- 위험 감지와 LLM context 생성은 `swmm_engine.risk` 내부 구현을 감싼다.
...
from swmm_engine.converter import (  # noqa: E402
    ConversionError,
...
from swmm_engine.engine import SwmmRuntimeEngine  # noqa: E402
