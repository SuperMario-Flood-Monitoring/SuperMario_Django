...
SUPERMARIO_LLM_DISPATCH_COOLDOWN_SECONDS = float(
    os.getenv("SUPERMARIO_LLM_DISPATCH_COOLDOWN_SECONDS", "300")
)
SUPERMARIO_LLM_AGGREGATION_SECONDS = float(
    os.getenv("SUPERMARIO_LLM_AGGREGATION_SECONDS", "60")
)
SUPERMARIO_LLM_EMERGENCY_AGGREGATION_SECONDS = float(
    os.getenv("SUPERMARIO_LLM_EMERGENCY_AGGREGATION_SECONDS", "30")
)
...
SUPERMARIO_FORECAST_MIN_OBSERVATION_SECONDS = int(
    os.getenv("SUPERMARIO_FORECAST_MIN_OBSERVATION_SECONDS", "15")
)
SUPERMARIO_FORECAST_MIN_CURRENT_FULLNESS = float(
    os.getenv("SUPERMARIO_FORECAST_MIN_CURRENT_FULLNESS", "0.10")
)
SUPERMARIO_FORECAST_MIN_CURRENT_DEPTH_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_MIN_CURRENT_DEPTH_RATIO", "0.10")
)
SUPERMARIO_FORECAST_MIN_CURRENT_CAPACITY_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_MIN_CURRENT_CAPACITY_RATIO", "0.10")
)
SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_FULLNESS = float(
    os.getenv("SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_FULLNESS", "0.20")
)
SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_DEPTH_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_DEPTH_RATIO", "0.20")
)
SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_CAPACITY_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_CLEAR_MIN_CURRENT_CAPACITY_RATIO", "0.20")
)
SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_FULLNESS = float(
    os.getenv("SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_FULLNESS", "0.05")
)
SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_DEPTH_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_DEPTH_RATIO", "0.05")
)
SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_CAPACITY_RATIO = float(
    os.getenv("SUPERMARIO_FORECAST_HEAVY_RAIN_MIN_CURRENT_CAPACITY_RATIO", "0.05")
)
SUPERMARIO_FORECAST_MAX_FULLNESS = float(os.getenv("SUPERMARIO_FORECAST_MAX_FULLNESS", "2.0"))
SUPERMARIO_FORECAST_MAX_DEPTH_RATIO = float(os.getenv("SUPERMARIO_FORECAST_MAX_DEPTH_RATIO", "2.0"))
SUPERMARIO_FORECAST_MAX_CAPACITY_RATIO = float(os.getenv("SUPERMARIO_FORECAST_MAX_CAPACITY_RATIO", "3.0"))
