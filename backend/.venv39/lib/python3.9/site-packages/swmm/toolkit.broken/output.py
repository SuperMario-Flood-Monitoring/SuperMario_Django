...
def get_elem_name(p_handle, type, elementIndex):
    r"""
...
def get_date_time(p_handle, periodIndex):
    return _output.get_date_time(p_handle, periodIndex)

def get_date_series(p_handle, startPeriod, endPeriod):
    return _output.get_date_series(p_handle, startPeriod, endPeriod)

def decode_date(date):
    return _output.decode_date(date)

def get_subcatch_series(p_handle, subcatchIndex, attr, startPeriod, endPeriod):
    r"""
...
def get_node_series(p_handle, nodeIndex, attr, startPeriod, endPeriod):
    r"""
    Get time series results for particular attribute. Specify series start and 
    length using timeIndex and length respectively.
...
def get_link_series(p_handle, linkIndex, attr, startPeriod, endPeriod):
    r"""
    Get time series results for particular attribute. Specify series start and 
    length using timeIndex and length respectively.
...
def get_system_series(p_handle, attr, startPeriod, endPeriod):
    r"""
    Get time series results for particular attribute. Specify series start and 
    length using timeIndex and length respectively.
...
def get_subcatch_attribute(p_handle, timeIndex, attr):
    r"""
...
def get_node_attribute(p_handle, timeIndex, attr):
    r"""
...
def get_link_attribute(p_handle, timeIndex, attr):
    r"""
...
def get_system_attribute(p_handle, timeIndex, attr):
    r"""
...
def get_subcatch_result(p_handle, timeIndex, subcatchIndex):
    r"""
...
def get_node_result(p_handle, timeIndex, nodeIndex):
    r"""
...
def get_link_result(p_handle, timeIndex, linkIndex):
    r"""
...
def get_system_result(p_handle, timeIndex, dummyIndex):
    r"""
